...
var ConfBot = /** @class */ (function () {
    //private _luis: LuisRecognizer;
    function ConfBot(qnaMaker) {
        this._qnaMaker = qnaMaker;
        //this._luis = luis;
    }
    ConfBot.prototype.onTurn = function (context) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._qnaMaker.generateAnswer(context.activity.text)];
                    case 1:
                        qnaResults = _a.sent();
                        if (!(qnaResults.length > 0)) return [3 /*break*/, 3];
                    ...
                    case 5: return [4 /*yield*/, context.sendActivity(context.activity.type + " event detected")];
                    case 6:
                        _a.sent();
                        _a.label = 7;
