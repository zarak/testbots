...
import { OAuthPrompt, DialogTurnStatus, Dialog, DialogSet, WaterfallDialog, WaterfallStepContext } from 'botbuilder-dialogs';
...
export class AuthBot {
    ...
    async onTurn(turnContext: TurnContext) {
        ...
        if (turnContext.activity.type === ActivityTypes.Message) {
            ...
            if (text === 'logout') {
                const prompt = new OAuthPrompt('signOut', {connectionName: 'test', title: 'Sign Out'});
                turnContext.sendActivity(`You have been logged out`);
                await prompt.signOutUser(turnContext);
            }
